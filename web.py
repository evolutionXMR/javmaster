...
async def api_push_resource(payload: ResourcePushPayload, _user=Depends(require_auth)):
    return ok(await app_core.push_resource_to_gopeed(payload.link, payload.code))
